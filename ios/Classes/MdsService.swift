...
final public class MdsService: NSObject {
    ...
    public func subscribe(_ uri: String,
                          ...
                          _ completionCb: @escaping (String, Int) -> (),
                          _ onNotify : @escaping (String) -> (),
                          _ onError : @escaping (String, Int) -> ()) {
        ...
        self.mds!.doSubscribe(uri,
                              ...
                              response: { (response) in
                                if response.statusCode < 300 {
                                    ...
                                    completionCb(self.convertResponse(response), response.statusCode)
                                } else {
            ...
            self.mds!.doPut(uri,
                            ...
                            completion: { (response) in
                                if response.statusCode < 300 {
                                    ...
                                    errorCb(response.header["Reason"] as! String, response.statusCode)
                                }
            });
    }
